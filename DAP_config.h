...
#define TARGET_DEVICE_VENDOR    "Nuvoton"           ///< String indicating the Silicon Vendor
#define TARGET_DEVICE_NAME      "M487JIDAE"         ///< String indicating the Target Device
#define TARGET_BOARD_VENDOR     "Nuvoton"           ///< String indicating the Board Vendor
#define TARGET_BOARD_NAME       "NuMaker-PFM-M487"  ///< String indicating the Board Name
